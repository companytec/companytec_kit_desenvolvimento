...
Function AlteraPreco(bico: ansistring; preco: double; decimais: byte)
  : Error; stdcall;
...
Function deleteTagFid(Posicao: integer; tag: ansistring): integer; stdcall;
...
Function SetBlackList(modo: char; tag: ansistring): boolean; stdcall;
Function PushBlackList(tag: PAnsiChar): boolean; stdcall;
Function PopBlackList(tag: PAnsiChar): boolean; stdcall;
Function ClearBlackList(): boolean; stdcall;
Function PresetId(bico:Byte;tag:string;valpreset,tempo:integer):ShortString; stdcall;
...
function ConsultaCodigoVirgulaPPL(bico:AnsiString):integer;stdcall;
