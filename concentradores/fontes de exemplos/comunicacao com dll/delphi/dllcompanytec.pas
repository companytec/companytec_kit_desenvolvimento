...
function VB_SendReceiveText(var st:string;timeout:integer):integer;stdcall;
...
function C_GetSalePAFExtended(): pchar;stdcall;
{$ENDIF}

implementation

{$IFNDEF COMPANYTEC}
function C_GetSalePAFExtended; external 'COMPANYTEC.DLL' name 'C_GetSalePAFExtended';
