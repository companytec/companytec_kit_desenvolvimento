...
type
  TForm1 = class(TForm)
    ...
    Label72: TLabel;
    btn_LeAbastecimentoPAF1: TButton;
    ...
    procedure btn_LeAbastecimentoPAF1Click(Sender: TObject);
...
//  ShowMessage(bico);
//  Erro := AlteraPreco(bico, strtofloat(preco), decimals);
...
var
  ...
  retorno: integer;
begin
  bico := edt_BicoConsultaCodigoVirgula.Text;
  retorno := ConsultaCodigoVirgulaPPL(bico);
  edt_RespostaConsultaCodigoVirgula.Text := IntToStr(retorno);
end;
// ------------------------------------------------------------------------------
...
procedure TForm1.btn_LeAbastecimentoPAF1Click(Sender: TObject);
var
  ab:AbastPAF1;
begin
...
begin
  try
    ab := LeAbastecimentoEstendido();
    memo_ReadExtendedSale.Lines.Add(ab.st_full);
