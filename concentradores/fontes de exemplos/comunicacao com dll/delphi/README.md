...
```
### Versão 5.10.0 - 18/08/2022
```
- Inserido comando C_GetSalePAFExtended.
- Inseridos comandos HabilitaIdf e DesabilitaIdf.
```
### Versão 5.11.0 - 25/11/2025
```
- Correção da estrutura abastpaf2 e da função leabastecimentoPAF2.
```